...
class WriterPerfTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $numRows = 2000000;
        $expectedMaxExecutionTime = 720; // seconds (12 minutes)
    ...
    private function getNumWrittenRowsUsingInlineStrings($resourcePath, $numSheets)
    {
        ...
        $maxRowsPerWorksheet = \ReflectionHelper::getStaticValue('\Box\Spout\Writer\XLSX\Internal\Workbook', 'maxRowsPerWorksheet');
