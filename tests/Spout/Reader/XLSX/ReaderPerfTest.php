...
class ReaderPerfTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return [
            [$shouldUseInlineStrings = true, $expectedMaxExecutionTime = 2100], // seconds (35 minutes)
            [$shouldUseInlineStrings = false, $expectedMaxExecutionTime = 4200], // seconds (70 minutes)
        ];
    }
